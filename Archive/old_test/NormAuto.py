...
import pandas as pd
import sys
sys.path.append(r"D:\Documents\IGDR-Dysplasie\Normalisation\file-concatenation-to-database\PythonScript")
...
set_value("PATH_TO_ORGA", r"D:\Documents\IGDR-Dysplasie\Normalisation\file-concatenation-to-database\20-06-08_ContenusFichiersNormalise_LLN.xlsx")
