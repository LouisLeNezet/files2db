...
db_orga["field_orga"]
colID = list(db_orga["field_orga"].loc[db_orga["field_orga"]["Category"] == "Identity", "Field"].values)
colIDSupl = list(db_orga["field_orga"].loc[db_orga["field_orga"]["Category"] == "IdentitySupl", "Field"].values)
...
allData.to_csv("/Users/louisln/Documents/EnCours/Concatenate/PythonScript/ScriptTest/AllID.csv",sep=";",index_label="Line")